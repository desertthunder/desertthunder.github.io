import { defaultLinks, isDefaultLinkCategory, themes } from "./data.js";
 ...
 * @typedef {{toggleSidebar(): void, closeSidebar(): void, toggleThemeVariant(): void, setTheme(themeId: string): void, setCity(city: string): void, addLink(link: {category: string, name: string, url: string}): boolean, renameCategory(category: string, name: string): boolean, removeLink(category: string, index: number): void, refreshWeather(): Promise<void>, startClock(): () => void}} StartpageActions
